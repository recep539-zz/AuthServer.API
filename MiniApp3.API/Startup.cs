...
namespace MiniApp3.API
{
    public class Startup
    {
        ...
        {
            services.Configure<CustomTokenOptions>(Configuration.GetSection("TokenOption"));// appsettingjson eriþmek için
            var tokenOptions = Configuration.GetSection("TokenOption").Get<CustomTokenOptions>();
            services.AddCustomTokenAuth(tokenOptions);// namespace e ekledik using SharedLibrary.Extensions;
